...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'phpbb.boardrules.admin.controller' => 'getPhpbb_Boardrules_Admin_ControllerService',
            'phpbb.boardrules.controller' => 'getPhpbb_Boardrules_ControllerService',
            'phpbb.boardrules.entity' => 'getPhpbb_Boardrules_EntityService',
            'phpbb.boardrules.listener' => 'getPhpbb_Boardrules_ListenerService',
            'phpbb.boardrules.nestedset_rules' => 'getPhpbb_Boardrules_NestedsetRulesService',
            'phpbb.boardrules.notification.type.boardrules' => 'getPhpbb_Boardrules_Notification_Type_BoardrulesService',
            'phpbb.boardrules.operator' => 'getPhpbb_Boardrules_OperatorService',
            'phpbb.boardrules.table_lock' => 'getPhpbb_Boardrules_TableLockService',
            'phpbb.boardrules.text_reparser.rule_text' => 'getPhpbb_Boardrules_TextReparser_RuleTextService',
        ...
        $this->privates = [
            ...
            'path_helper' => true,
            'php_ini' => true,
            'phpbb.boardrules.admin.controller' => true,
            'phpbb.boardrules.controller' => true,
            'phpbb.boardrules.entity' => true,
            'phpbb.boardrules.listener' => true,
            'phpbb.boardrules.nestedset_rules' => true,
            'phpbb.boardrules.notification.type.boardrules' => true,
            'phpbb.boardrules.operator' => true,
            'phpbb.boardrules.table_lock' => true,
            'phpbb.boardrules.text_reparser.rule_text' => true,
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addListener('core.user_setup', [0 => function () {
            return ${($_ = isset($this->services['phpbb.boardrules.listener']) ? $this->services['phpbb.boardrules.listener'] : $this->getPhpbb_Boardrules_ListenerService()) && false ?: '_'};
    ...
    protected function getNotification_TypeCollectionService()
    {
        ...
        $instance->add('phpbb.boardrules.notification.type.boardrules');
    ...
    /**
     * Gets the private 'phpbb.boardrules.admin.controller' shared service.
     *
     * @return \phpbb\boardrules\controller\admin_controller
     */
    protected function getPhpbb_Boardrules_Admin_ControllerService()
    {
        return $this->services['phpbb.boardrules.admin.controller'] = new \phpbb\boardrules\controller\admin_controller(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, $this, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['notification_manager']) ? $this->services['notification_manager'] : $this->getNotificationManagerService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['phpbb.boardrules.operator']) ? $this->services['phpbb.boardrules.operator'] : $this->getPhpbb_Boardrules_OperatorService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php');
    }

    /**
     * Gets the private 'phpbb.boardrules.controller' shared service.
     *
     * @return \phpbb\boardrules\controller\main_controller
     */
    protected function getPhpbb_Boardrules_ControllerService()
    {
        return $this->services['phpbb.boardrules.controller'] = new \phpbb\boardrules\controller\main_controller(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.boardrules.operator']) ? $this->services['phpbb.boardrules.operator'] : $this->getPhpbb_Boardrules_OperatorService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php');
    }

    /**
     * Gets the private 'phpbb.boardrules.entity' service.
     *
     * @return \phpbb\boardrules\entity\rule
     */
    protected function getPhpbb_Boardrules_EntityService()
    {
        return new \phpbb\boardrules\entity\rule(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_boardrules');
    }

    /**
     * Gets the private 'phpbb.boardrules.listener' shared service.
     *
     * @return \phpbb\boardrules\event\listener
     */
    protected function getPhpbb_Boardrules_ListenerService()
    {
        return $this->services['phpbb.boardrules.listener'] = new \phpbb\boardrules\event\listener(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, 'php');
    }

    /**
     * Gets the private 'phpbb.boardrules.nestedset_rules' shared service.
     *
     * @return \phpbb\boardrules\operators\nestedset_rules
     */
    protected function getPhpbb_Boardrules_NestedsetRulesService()
    {
        return $this->services['phpbb.boardrules.nestedset_rules'] = new \phpbb\boardrules\operators\nestedset_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['phpbb.boardrules.table_lock']) ? $this->services['phpbb.boardrules.table_lock'] : $this->getPhpbb_Boardrules_TableLockService()) && false ?: '_'}, 'phpbb_boardrules');
    }

    /**
     * Gets the private 'phpbb.boardrules.notification.type.boardrules' service.
     *
     * @return \phpbb\boardrules\notification\boardrules
     */
    protected function getPhpbb_Boardrules_Notification_Type_BoardrulesService()
    {
        $instance = new \phpbb\boardrules\notification\boardrules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'phpbb_user_notifications');
    ...
    /**
     * Gets the private 'phpbb.boardrules.operator' shared service.
     *
     * @return \phpbb\boardrules\operators\rule
     */
    protected function getPhpbb_Boardrules_OperatorService()
    {
        return $this->services['phpbb.boardrules.operator'] = new \phpbb\boardrules\operators\rule($this, ${($_ = isset($this->services['phpbb.boardrules.nestedset_rules']) ? $this->services['phpbb.boardrules.nestedset_rules'] : $this->getPhpbb_Boardrules_NestedsetRulesService()) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.boardrules.table_lock' shared service.
     *
     * @return \phpbb\lock\db
     */
    protected function getPhpbb_Boardrules_TableLockService()
    {
        return $this->services['phpbb.boardrules.table_lock'] = new \phpbb\lock\db('boardrules.table_lock.boardrules_table', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'});
    }

    /**
     * Gets the private 'phpbb.boardrules.text_reparser.rule_text' shared service.
     *
     * @return \phpbb\boardrules\textreparser\plugins\rule_text
     */
    protected function getPhpbb_Boardrules_TextReparser_RuleTextService()
    {
        $this->services['phpbb.boardrules.text_reparser.rule_text'] = $instance = new \phpbb\boardrules\textreparser\plugins\rule_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb_boardrules');

        $instance->set_name('phpbb_boardrules_rules');
    ...
    protected function getTextReparserCollectionService()
    {
        ...
        $instance->add('phpbb.boardrules.text_reparser.rule_text');
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'phpbb.boardrules.tables.boardrules' => 'phpbb_boardrules',
            'tables' => [
